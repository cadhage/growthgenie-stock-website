...
const ClientScreen = ({
  ...
  const renderContent = () => {
    if (!selectedButton) {
      // Display company information when no button is selected
      return (
        <div>
    ...
    switch (selectedButton) {
      case "Mutual Funds":
        return <p>Content for Mutual Funds goes here...</p>;
      case "Fixed Deposit":
        return <p>Content for Fixed Deposit goes here...</p>;
      case "Stokes":
        return <p>Content for Stokes goes here...</p>;
      default:
        return null;
    }
  };
      ...
      {showButtons && (
        <div className={`horizontal-menu${isMobile ? " mobile-view" : ""}`}>
          ...
          <button
            className="menu-item"
            onClick={() => {
              handleButtonClick("Mutual Funds");
              handleMutualFundClick();
            }}
          >
            Mutual Funds
          ...
          <button
            className="menu-item"
            onClick={() => {
              handleButtonClick("Fixed Deposit");
              handleFixedDepositClick();
            }}
          >
            Fixed Deposit
